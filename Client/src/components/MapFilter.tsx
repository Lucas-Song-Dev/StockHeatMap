      ...
      <div className="bg-[#242632] p-4 rounded">
        <div className="mb-2">
          ...
          <div className="flex space-x-2 mb-4">
            <div className="text-white text-sm font-bold border-b-2 border-white pb-1">
              Map
            </div>
            {/* <div className="text-white/50 text-sm cursor-pointer hover:text-white pb-1">
              Bubbles
            </div> */}
          </div>
          <div className="text-[#61697a] text-xs mb-6">
            All stocks listed on US stock exchanges, categorized by sectors and
        ...
        <div className="text-[#61697a] text-xs">
          <p className="mb-1">
            Compare and visualize movement of the largest US stocks
          </p>
        </div>
      </div>
    </div>
