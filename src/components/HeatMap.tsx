...
const sampleData: SectorData[] = [
  {
    ...
    stocks: [
      ...
      { ticker: "SAP", change: 0.0, sector: "SOFTWARE - APPLICATION" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { ticker: "TM", change: -2.8, sector: "AUTO MANUFACTURERS" },
    ],
  },
  {
  ...
  },
  {
    ...
    stocks: [
      ...
      { ticker: "PFE", change: -0.7, sector: "DRUG MANUFACTURERS - GENERAL" },
    ],
  },
  {
    name: "FINANCIAL",
    stocks: [
      ...
      { ticker: "C", change: -4.9, sector: "BANKS - DIVERSIFIED" },
  ...
  useEffect(() => {
    ...
    const loadStockData = async () => {
      try {
        ...
        console.log("🚀 ~ loadStockData ~ data:", data);
        setHeatmapData(data);
      } catch (err) {
